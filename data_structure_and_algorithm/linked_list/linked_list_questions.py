    ...
    def merge(self, l1, l2):
        ...
        while itr1 and itr2:
            if itr1.data <= itr2.data:
                self.insert_at_end(itr1.data)
                itr1 = itr1.next
            else:
                self.insert_at_end(itr2.data)
                itr2 = itr2.next
        while itr1:
            self.insert_at_end(itr1.data)
            itr1 = itr1.next
...
if __name__ == '__main__':
    ll1 = LinkedList()
    ll2 = LinkedList()
    ll1.insert_values([0, 1, 2, 3, 4, 100])
    ll2.insert_values([2, 4, 5, 7, 11, 13, 17, 23, 29, 500, 5000])
    ll3 = LinkedList()
    ll3.merge(ll1, ll2)
    ...
    print('Duplicate element: ', ll.find_duplicate())
